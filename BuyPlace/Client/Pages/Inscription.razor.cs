    ...
    public partial class Inscription
    {
        ...
        private async Task SignInUser()
        {
            ...
            if (url == "inscription")
            {
                ...
                var loginResponseUserName = await httpClient.PostAsJsonAsync("api/Account/GetbyUserName", user.Nom);
                var loginResponseCourriel = await httpClient.PostAsJsonAsync("api/Account/GetbyCourriel", user.Courriel);
